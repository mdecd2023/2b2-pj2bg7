...
%=---------------報告製作核可證明---------------------=%
 ...
 {\begin{center}
    ...
    {\begin{minipage}[t]{10em}\underline{四設二乙\enspace 41023219 第一位}\\ \underline{四設二乙\enspace 41023221\enspace 第二位}\\ \underline{四設二乙\enspace 41023222\enspace 第三位}\\ \underline{四設二乙\enspace 41023228\enspace 第四位}\\ \underline{四設二乙\enspace 41023195\enspace 第五位}\\ %下劃線符號指令
    \end{minipage}}
         \par} %結束指定行距
    ...
    \fontsize{16pt}{2.5pt}\selectfont\makebox[8em][s]{五月十七日}
    \end{flushleft}}
    \end{textblock}}
    \end{textblock}}
     \par} %結束指定行距
