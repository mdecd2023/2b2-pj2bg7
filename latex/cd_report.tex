...
%=---------------報告製作核可證明---------------------=%
 ...
 {\begin{center}
    ...
    {\begin{minipage}[t]{10em}\underline{四設二乙\enspace 41023219 陳冠佑}\\ \underline{四設二乙\enspace 41023221\enspace 陳冠宇}\\ \underline{四設二乙\enspace 41023222\enspace 鄭立揚}\\ \underline{四設二乙\enspace 41023228\enspace 謝鴻元}\\ %下劃線符號指令
    \end{minipage}}
         \par} %結束指定行距
